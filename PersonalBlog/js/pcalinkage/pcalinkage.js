// 纯JS省市区三级联动
var pcalinkageInit = function (name, defaultProvince, defaultCity, defaultArea) {
    var cmbProvince = document.getElementById(name + "province");
    var cmbCity = document.getElementById(name + "city");
    var cmbArea = document.getElementById(name + "area");
    var hideValue = document.getElementById(name);
    var hideValues = hideValue.value.split('-');
    if (hideValues.length >= 3) {
        defaultProvince = hideValues[0];
        defaultCity = hideValues[1];
        defaultArea = hideValues[2];
    }
    if (hideValues.length == 2) {
        defaultProvince = hideValues[0];
        defaultCity = hideValues[1];
    }
    if (hideValues.length == 1) {
        defaultProvince = hideValues[0];
    }
    ...
    function changeArea() {
        if (cmbProvince.value != "undefined" && cmbProvince.value != null && cmbCity.value != "undefined" && cmbCity.value != null && this.value != "undefined" && this.value != null)
            hideValue.value = cmbProvince.value + "-" + cmbCity.value + "-" + this.value;
    }
    function changeCity() {
        if (cmbProvince.value != "undefined" && cmbProvince.value != null && this.value != "undefined" && this.value != null)
            hideValue.value = cmbProvince.value + "-" + this.value;
        if (cmbArea != null) {
